// components/Sign_up/Hirer_SignUp.jsx
import { motion } from "framer-motion";

const Hirer_SignUp = ({ onClose, goBack }) => {
    return (
            ...
            <div className="flex flex-col bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="bg-orange-500 p-6 text-white relative">
                    <div className="flex justify-between items-center w-full mb-4">
                        ...
                        <h2 className="text-lg font-semibold">Hirer</h2>
                        <button
                            onClick={onClose}
                            className="text-white text-xl hover:bg-white/20 px-3 rounded-full transition flex items-center"
                        >
                ...
                <div className="p-6">
                    ...
                    <form className="space-y-6 mt-2">
                        ...
                        <button
                            type="button"
                            className="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-600 transition mt-8"
                        >
                            Create Account
                        </button>
