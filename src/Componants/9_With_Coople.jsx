    ...
    return (
        <section className="">
            <div className="max-w-7xl mx-auto p-14">
                <div className='flex gap-3 justify-center flex-col items-center px-8'>
                    <h2 className='text-3xl text-center'>With Coople, you can quickly adapt your staffing model when business <br /> changes.</h2>
